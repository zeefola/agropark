                ...
                <div class="row ttm-boxes-row-wrapper">
                    <div class="col-md-4 ttm-box-col-wrapper">
                        ...
                        <ul class="ttm_contact_widget_wrapper">
                            <li><i class="ttm-textcolor-skincolor ti ti-location-pin"></i> {{config('app.address_ikoyi') }}</li>
                            <li><i class="ttm-textcolor-skincolor ti ti-comment"></i><a href="mailto:info@agropark.ng"> {{ config('app.email_1') }}</a></li>
                    ...
                    <div class="col-md-4 ttm-box-col-wrapper">
                        ...
                        <ul class="ttm_contact_widget_wrapper">
                            <li><i class="ttm-textcolor-skincolor ti ti-location-pin"></i>{{config('app.address_celias') }}</li>
                            <li><i class="ttm-textcolor-skincolor ti ti-comment"></i><a href="mailto:info@agropark.ng">{{ config('app.email_1') }}</a></li>
                    ...
                    <div class="col-md-4 ttm-box-col-wrapper">
                        ...
                        <ul class="ttm_contact_widget_wrapper">
                            <li><i class="ttm-textcolor-skincolor ti ti-location-pin"></i>{{config('app.address_london') }}</li>
                            <li><i class="ttm-textcolor-skincolor ti ti-comment"></i><a href="mailto:info@agropark.ng"> {{ config('app.email_london') }}</a></li>
                ...
                <div class="row pt-60 res-991-pt-0">
                    <div class="col-lg-8">
                        ...
                        @includeIf('layouts.error_template')
                            ...
                            <!-- section-title end -->
                            <form id="ttm-contactform" class="ttm-contactform wrap-form style2 res-991-mt_15 clearfix" method="post" action="/contact-us">
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-md-6">
                                        <label>Full Name *</label>
                                        <span class="text-input"><input name="fullname" type="text" value="" placeholder="" ></span>
                                    </div>
                                    <div class="col-md-6">
                                        <label>Your email *</label>
                                        <span class="text-input"><input name="email" type="email" value="" placeholder="" ></span>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <span class="text-input"><input name="interest" type="text" value="" placeholder="" ></span>
                                    </div>
                                    <div class="col-md-12">
                                        <label>Your Message *</label>
                                        <span class="text-input"><textarea name="message" cols="40" rows="6" placeholder="" ></textarea></span>
                                    </div>
                            ...
                            <div class="social-icons circle social-hover">
                                <div class="ttm-socialbox-links-wrapper row">
                                    <div class="ttm-socialbox-i-wrapper col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <a class="tooltip-top ttm-socialbox-icon-link-twitter" target="_blank" href="{{ config('app.twitter') }}" data-tooltip="Twitter">
                                    ...
                                    <div class="ttm-socialbox-i-wrapper col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <a class="tooltip-top ttm-socialbox-icon-link-facebook" target="_blank" href="{{ config('app.facebook') }}" data-tooltip="Facebook">
                                            <i class="fa fa-facebook" aria-hidden="true"></i>
                                            <span class="ttm-link">facebook</span>
                                        </a>
                                    </div>
                                    <div class="ttm-socialbox-i-wrapper col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <a class="tooltip-top ttm-socialbox-icon-link-twitter" target="_blank" href="{{ config('app.instagram') }}" data-tooltip="Instagram">
